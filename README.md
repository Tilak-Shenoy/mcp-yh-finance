...
This should automatically pull the code and run the tools. Follow [Get RapidAPI Key](#get-rapidapi-key) to get your API KEY. You can stop here if you are not interested in making any code changes to the server.
